...
export const metadata: Metadata = {
    title: "수료 소감 | 벼랑영어",
    description: "정직한 수강생들의 리얼 보이스, 벼랑영어 수료 소감을 확인해보세요.",
    openGraph: {
        title: "수료 소감 | 벼랑영어",
        description: "정직한 수강생들의 리얼 보이스, 벼랑영어 수료 소감을 확인해보세요.",
        type: "website",
                ...
                <section className="bg-brand-gray py-12 md:py-20 border-b border-brand-yellow/30">
                    <div className="container mx-auto px-6 max-w-7xl">
                        <ClientMotionDiv
                            ...
                            className="space-y-4"
                        >
                            <h1 className="text-3xl md:text-6xl font-black tracking-tighter text-brand-black leading-tight">
                    ...
                    <div className="container mx-auto px-6 max-w-7xl">
                        <div className="flex flex-col md:flex-row gap-12 mb-20">
                            <div className="md:w-1/4">
                                <h2 className="text-4xl font-black tracking-tighter italic border-l-8 border-brand-yellow pl-6 uppercase">
                                    Real Voice
